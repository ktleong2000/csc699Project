...
public class NetworkResponseTable {
	...
	public static void init() {
		...
		//Add my game's own response move to the constants table
		add(Constants.QDM_SMSG_MOVE, "QDMResponseMove");
		add(Constants.QDM_SMSG_AIM, "QDMResponseAim");
		add(Constants.QDM_SMSG_DMG, "QDMResponseDamage");
	}
