...
public class NetworkRequestTable {
	...
	public static void init() {
		...
		//Added the constant to the list of initialized constants
		//In the network request table
		add(Constants.QDM_CMSG_MOVE, "QDMRequestMove");
		add(Constants.QDM_CMSG_AIM, "QDMRequestAim");
		add(Constants.QDM_CMSG_DMG, "QDMRequestDamage");
	}
