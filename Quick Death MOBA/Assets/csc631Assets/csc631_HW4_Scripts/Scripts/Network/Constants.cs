public class Constants
{
	...
	//Added new move constants to the Network Request Table for my own protocols
	public static readonly short QDM_CMSG_MOVE = 107;
	public static readonly short QDM_SMSG_MOVE = 207;
	public static readonly short QDM_CMSG_AIM = 108;
	public static readonly short QDM_SMSG_AIM = 208;
	public static readonly short QDM_CMSG_DMG = 109;
	public static readonly short QDM_SMSG_DMG = 209;
