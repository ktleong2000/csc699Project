...
public class GameManager : MonoBehaviour
{
	...
	{
		//GameObject heroObj1 = Instantiate(HeroPrefab);
		for (int i = 0; i < 1; i++)
		{
			//Instantiate a new object using the Hero Prefab which is now set to my prefab
			//This does it for both players so I run the loop once in hopes it works.
			GameObject heroObj1 = Instantiate(HeroPrefab);
			...
			gameBoard[0, i] = hero1;
			GameObject heroObj2 = Instantiate(HeroPrefab);
