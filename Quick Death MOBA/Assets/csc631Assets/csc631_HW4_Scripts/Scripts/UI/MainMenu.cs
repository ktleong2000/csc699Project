...
public class MainMenu : MonoBehaviour
{
	...
	{
		QDMGameManager gameManager = GameObject.Find("Game Manager").GetComponent<QDMGameManager>();
		...
		//Set the third argument while creating character appropriately so we know if it is hotseat or
		//it is going to be networked, in this case hotseat
		Player player1 = new Player(1, p1Name, true);
		Player player2 = new Player(2, p2Name, true);
		gameManager.Init(player1, player2);
		SceneManager.LoadScene("QMOBA_BV1");
	}
	...
	private void StartNetworkGame()
	{
		...
		//Set the third argument while creating character appropriately so we know if it is hotseat or
		//it is going to be networked, in this case networked
		Player player1 = new Player(1, p1Name, Constants.USER_ID == 1);
		Player player2 = new Player(2, p2Name, Constants.USER_ID == 2);
		gameManager.Init(player1, player2);
		SceneManager.LoadScene("QMOBA_BV1");
	}
}
