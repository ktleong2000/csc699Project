...
public class S_PlayerMovement : NetworkBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        // movement.
        xRotation = previousMovementInput.x * turningRate * Time.deltaTime;
        UnityEngine.Quaternion newRotation = UnityEngine.Quaternion.Euler(xRotation, 0f, 0f);
        
        // Debugging: Print the new rotation to the console
